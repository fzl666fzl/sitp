...
class QMIX:
    def __init__(self, conf):
        ...
        if self.conf.load_model:
            if os.path.exists('D:/研三/dalunwen2_2/models/3m/0_drqn_net_params.pkl'):
                drqn_path = 'D:/研三/dalunwen2_2/models/3m/0_drqn_net_params.pkl'
                qmix_path = 'D:/研三/dalunwen2_2/models/3m/0_qmix_net_params.pkl'
            # if os.path.exists('D:/研三/dalunwen2_2/models/3m/02_drqn_net_params.pkl'):
            #     drqn_path = 'D:/研三/dalunwen2_2/models/3m/02_drqn_net_params.pkl'
            #     qmix_path = 'D:/研三/dalunwen2_2/models/3m/02_qmix_net_params.pkl'
            # if os.path.exists('D:/研三/dalunwen2_2/models/3m/03_drqn_net_params.pkl'):
            #     drqn_path = 'D:/研三/dalunwen2_2/models/3m/03_drqn_net_params.pkl'
            #     qmix_path = 'D:/研三/dalunwen2_2/models/3m/03_qmix_net_params.pkl'
