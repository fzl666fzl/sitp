...
from config_qatten_si_shaping_v2 import Config
...
def train():
    ...
    set_eval_seed(conf)
    print(
        "online entry: QATTEN_SI_SHAPING_V2_online.py",
        "beta:",
        conf.si_shaping_beta,
        "mode:",
        conf.si_shaping_mode,
        "model_dir:",
        conf.model_dir,
        "model_tag:",
        conf.model_tag,
    ...
    print("\n===== QATTEN SI-shaping V2 online summary =====")
    print("beta:", conf.si_shaping_beta)
    print("mode:", conf.si_shaping_mode)
