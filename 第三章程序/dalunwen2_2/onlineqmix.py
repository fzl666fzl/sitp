...
def train():
    ...
    for epoch in range(1):
        ...
        for episode_idx in range(conf.n_eposodes):##n_eposodes=1
            episode, times, pp = onlinerollout.generate_episode(agents, conf,pulses,now_pulse,epoch,SI)
            # episode, times, pp = onlinerollout1.generate_episode(agents, conf, pulses, now_pulse, epoch, SI)##
