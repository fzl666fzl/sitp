...
def train():
    ...
    for epoch in range(1):
        ...
        now_pulse = 608 #这里先确定节拍
        pulses = []
        for episode_idx in range(conf.n_eposodes):##n_eposodes=1
            episode= onlinerollout.generate_episode(agents, conf,pulses,now_pulse,epoch,SI)
...
def notrain():
    ...
    rollout_notrain.generate_episode(agents, conf, pulses, now_pulse, 1, SI)
