...
"""
@Time: 2023.12.18
@Scipt:该文件处理扰动，且在文件第二类扰动处理上修改了稳定性评价指标
...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        # df_start.to_excel('D:/研三/扰动数据说明/工序开始时间_我就看看3.xlsx')
        # df_finish.to_excel('D:/研三/扰动数据说明/工序结束时间_我就看看3.xlsx')
        # df_statisworker.to_excel('D:/研三/扰动数据说明/要展示的工序扰动我就看看3.xlsx')
