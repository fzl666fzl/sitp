...
def disturbance2(env, allstation, airs):
    ...
    plt.show()
    for ind in P_t:
        if ind.objective[2] < 9 and ind.objective[1] < 80:
            print("当前的解及其性能")
    ...
    df_start.to_excel('D:/研三/大论文第四章数据/工序开始时间_432.xlsx')
    df_finish.to_excel('D:/研三/大论文第四章数据/工序结束时间_432.xlsx')
    df_statisworker.to_excel('D:/研三/大论文第四章数据/要展示的工序扰动432.xlsx')
...
def resel_station(env,allstations,dis_station,dis_team):

    cur_time = 605  ##装配开始的时间5   25
...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        # df_start.to_excel('D:/研三/大论文第四章数据/工序开始时间_431.xlsx')
        # df_finish.to_excel('D:/研三/大论文第四章数据/工序结束时间_431.xlsx')
        # df_statisworker.to_excel('D:/研三/大论文第四章数据/要展示的工序扰动431.xlsx')
