...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        # df_start.to_excel('D:/研三/扰动数据说明/工序开始时间_nsga0.xlsx')
        # df_finish.to_excel('D:/研三/扰动数据说明/工序结束时间_nsga0.xlsx')
        # df_statisworker.to_excel('D:/研三/扰动数据说明/要展示的工序扰动nsga0.xlsx')
